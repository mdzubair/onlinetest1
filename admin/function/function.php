...
if(isset($_POST['addsubject']) == TRUE)
{
	...
	$coaching_id = $_POST['coachingname'];
if($sub_name == "" || $coaching_id == "")
{
...
{
	$query_s = mysqli_query($conn ,"insert into mst_subject(coaching_id,sub_name)values('$coaching_id','$sub_name')");
	if($query_s)
	{
...
if(isset($_POST['setAtest']) == TRUE)
{
	...
	$query_s = mysqli_query($conn ,"insert into mst_test(sub_id,coaching_id,test_name,date,total_que,duration)values('$sub_id','$coaching_id','$test_name','$test_date','$test_no','$test_time')");
	if($query_s)
	{
