...
<a href="addmember" class="small-box-footer">Add Now <i class="fa fa-arrow-circle-right"></i></a>
</div>
</div><!-- ./col -->
<div class="col-lg-3 col-xs-6">
<!-- small box -->
...
<div class="inner">
<h3><i class="fa fa-rocket"></i></h3>
<p>Manage Members</p>
</div>
<div class="icon" style="color:#fff;">
<i class="ion ion-search"></i>
</div>
<a href="search-member" class="small-box-footer">Manage Now <i class="fa fa-arrow-circle-right"></i></a>
</div>
</div><!-- ./col -->
<div class="col-lg-3 col-xs-6">
<!-- small box -->
