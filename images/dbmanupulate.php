...
$get_new_table = "CREATE TEMPORARY TABLE IF NOT EXISTS table_exam AS (SELECT * FROM mst_question LIMIT 10)";
...
<label class='radio-inline ansp'><input type='radio' class='radio' name='right_answer$que_id' value='1' onclick='answ(this.value,$que_id)' />$ans1</label>
             </div>
             <div class='col-md-6 col-xs-12'>
<label class='radio-inline ansp'><input type='radio' class='radio' name='right_answer$que_id' value='2' onclick='answ(this.value,$que_id)' />$ans2</label>
             </div>
             <div class='col-md-6 col-xs-12'>
<label class='radio-inline ansp'><input type='radio' class='radio' name='right_answer$que_id' value='3' onclick='answ(this.value,$que_id)' />$ans3</label>
             </div>
             <div class='col-md-6 col-xs-12'>
<label class='radio-inline ansp'><input type='radio' class='radio' name='right_answer$que_id' value='4' onclick='answ(this.value,$que_id)' />$ans4</label>
             </div>
