...
<h2 style="padding-bottom: 50px; float:left; width:auto; "><div style="width:auto; float:left; ">(A) <input type="radio" value="1" onclick="rad(this.value,<?php echo $id1; ?>);" name="opti"> </div><div style="width:auto; float:left; "> <?php echo $option_a_sec_fst;?></div><div style="width:auto; float:left; "><?php echo $option_a_sec;?></div></h2>
...
<div class="clearfix"></div>
<h2 style="padding-bottom: 50px; float:left; width:auto;  "><div style="width:auto; float:left; ">(B) <input type="radio" value="2" onclick="rad(this.value,<?php echo $id1; ?>);" name="opti"> </div><div style="float:left; width:auto;"><?php echo $option_b_sec_fst;?></div><div style="float:left; width:auto;"><?php echo $option_b_sec;?></div></h2>
<div class="clearfix"></div>
...
<h2 style="padding-bottom: 50px; float:left; width:auto;  "> <div style="width:auto; float:left; ">(C) <input type="radio" value="3" onclick="rad(this.value,<?php echo $id1; ?>);" name="opti"> </div> <div style="float:left; width:auto;"><?php echo $option_c_sec_fst;?></div><div style="float: left;
...
?>
<div class="clearfix"></div>
<h2 style="padding-bottom: 50px; float:left; width:auto;   "><div style="width:auto; float:left; ">(D) <input type="radio" value="4" onclick="rad(this.value,<?php echo $id1; ?>);" name="opti"> </div> <div style="float:left; width:auto !important;"><?php echo $option_d_sec_fst;?></div><div style="float:left; width:auto;  "><?php echo $option_d_sec;?></div></h2>
